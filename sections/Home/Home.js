  ...
  return (
    <div className={styles.home}>
      ...
      <p>I'm a front-end software engineer who is deeply passionate about user experience and product design. 
         My goal is to bridge the gap between elegance and efficiency in enterprise and consumer web applications 
         while creating a digital world that is reliable, accessible, and equitable for all.</p>
